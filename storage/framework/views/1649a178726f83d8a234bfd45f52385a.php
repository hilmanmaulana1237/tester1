<div x-data="{
    ...
    tabFilter: 'all',
    audioCtx: null,
    previousCount: <?php echo e($unreadCount); ?>,
    isNavigating: false,
    notifCount: <?php echo e($notifications->count()); ?>,
    lockedHeight: null,
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        <div class="flex items-center justify-between px-4 py-3 bg-gradient-to-r from-violet-600 to-purple-600">
            <h3 class="text-sm font-bold text-white flex items-center gap-2">
                🔔 Notifikasi
                <!--[if BLOCK]><![endif]--><?php if($unreadCount > 0): ?>
                    <span class="text-[10px] bg-white/20 text-white px-1.5 py-0.5 rounded-full"><?php echo e($unreadCount); ?> baru</span>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </h3>
        ...
        <div class="flex border-b border-gray-100 bg-gray-50">
            ...
            <button @click="tabFilter = 'unread'"
                ...
                Belum Dibaca
                <!--[if BLOCK]><![endif]--><?php if($unreadCount > 0): ?>
                    <span class="ml-1 inline-flex items-center justify-center w-4 h-4 text-[9px] font-bold text-white bg-red-500 rounded-full"><?php echo e($unreadCount > 9 ? '9+' : $unreadCount); ?></span>
                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
            </button>
        </div>
        ...
        <div id="notif-list-container"
            ...
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="group relative" x-show="tabFilter === 'all' || <?php echo e($notification->read ? 'false' : 'true'); ?>">
                    <button
                        @click="clickNotif(<?php echo e($notification->id); ?>, '<?php echo e($notification->action_url ?? ''); ?>')"
                        class="w-full text-left px-4 py-3 hover:bg-violet-50/50 transition-colors <?php echo e(!$notification->read ? 'bg-violet-50/30 border-l-3 border-l-violet-500' : ''); ?>">
                        <div class="flex items-start gap-3">
                            
                            <div class="flex-shrink-0 w-10 h-10 rounded-xl <?php echo e($notification->color_class); ?> flex items-center justify-center text-base shadow-sm">
                                <?php echo e($notification->icon); ?>
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-start justify-between gap-2">
                                    <h4 class="text-sm font-semibold text-gray-800 truncate <?php echo e(!$notification->read ? 'text-gray-900' : 'text-gray-600'); ?>">
            ...
            <!--[if BLOCK]><![endif]--><?php if($visibleUnreadCount === 0): ?>
        ...
        <?php if($notifications->count() > 0): ?>
            <div class="px-4 py-2.5 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
                ...
                <span class="text-[10px] text-gray-400">
                    <?php echo e($notifications->count()); ?> notifikasi
                </span>
            </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    </div>
...
<?php /**PATH C:\laragon\www\baru\resources\views/livewire/notification-panel.blade.php ENDPATH**/ ?>