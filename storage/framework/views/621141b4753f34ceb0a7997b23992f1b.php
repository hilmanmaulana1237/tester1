            ...
            <!--[if BLOCK]><![endif]--><?php if($viewMode === 'categories'): ?>
                ...
                <div class="grid grid-cols-1 gap-4">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        ?>
                        <div wire:click="selectCategory(<?php echo e($category->id); ?>)" wire:loading.class="opacity-50 cursor-wait"
                            wire:target="selectCategory(<?php echo e($category->id); ?>)"
                            class="bg-white rounded-xl border <?php echo e($isPremiumAdmin ? 'border-amber-400 ring-2 ring-amber-200' : 'border-zinc-200'); ?> p-4 hover:shadow-lg transition-all duration-200 cursor-pointer group hover:border-violet-300 relative overflow-hidden">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                ?>
                                <div
                                    class="w-10 h-10 <?php echo e($isPremiumAdmin ? 'bg-gradient-to-br from-amber-400 to-yellow-500' : 'bg-gradient-to-br from-blue-500 to-purple-600'); ?> rounded-lg flex items-center justify-center text-white font-bold text-sm group-hover:scale-110 transition-transform duration-200">
                                    <?php echo e($initials); ?>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center gap-2 text-xs">
                                        <span class="text-zinc-600"><?php echo e($category->available_tasks_count); ?> tersedia</span>
                                        <!--[if BLOCK]><![endif]--><?php if($category->in_progress_count > 0): ?>
                                            <span class="text-amber-600">• <?php echo e($category->in_progress_count); ?> dikerjakan</span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                </div>
                                <div
                                    ...
                                    <!-- Loading spinner -->
                                    <svg wire:loading wire:target="selectCategory(<?php echo e($category->id); ?>)" style="display: none;"
                                    ...
                                    <!-- Arrow icon -->
                                    <svg wire:loading.remove wire:target="selectCategory(<?php echo e($category->id); ?>)"
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($category->createdBy): ?>
                                <div
                                    class="mt-3 flex items-center gap-2 text-xs <?php echo e($isPremiumAdmin ? 'text-amber-600' : 'text-zinc-500'); ?>">
            ...
            <?php else: ?>
                ...
                <div class="flex flex-col gap-3">
                    ...
                    <div class="bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-200 rounded-xl p-4">
                        <h1 class="text-xl font-bold text-zinc-900 text-center"><?php echo e($selectedCategoryName); ?></h1>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($selectedCategoryAdmin): ?>
                        ...
                        ?>
                        <div
                            class="bg-gradient-to-r <?php echo e($isPremiumAdmin ? 'from-amber-50 to-yellow-50 border-amber-200' : 'from-blue-50 to-indigo-50 border-blue-200'); ?> border rounded-xl p-3">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-10 h-10 <?php echo e($isPremiumAdmin ? 'bg-gradient-to-br from-amber-400 to-yellow-500' : 'bg-gradient-to-br from-blue-500 to-indigo-600'); ?> rounded-full flex items-center justify-center text-white font-bold text-sm shadow-lg">
                                ...
                                <div class="flex-1">
                                    <div class="flex items-center gap-2">
                                        <span
                                            class="font-semibold text-sm text-zinc-900"><?php echo e($selectedCategoryAdmin->name); ?></span>
                                        <!--[if BLOCK]><![endif]--><?php if($isPremiumAdmin): ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($selectedCategoryAdmin->whatsapp): ?>
                                    <a href="https://wa.me/<?php echo e($selectedCategoryAdmin->whatsapp); ?>" target="_blank"
                            ...
                            <div class="bg-white rounded-xl border border-zinc-200 p-4 space-y-3">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="px-2 py-1 rounded text-xs font-medium
                                                                   <?php if($task->difficulty_level === 'easy'): ?> bg-violet-100 text-purple-800
                                ...
                                <div class="flex items-center gap-2 p-2 bg-zinc-50 rounded-lg">
                                    <div
                                        ...
                                        <span
                                            class="text-white text-xs font-bold"><?php echo e(substr($task->creator->name ?? 'A', 0, 1)); ?></span>
                                    </div>
                                    ...
                                    <div class="border-t border-zinc-200 pt-3 space-y-2">
                                        ...
                                        <div class="flex items-center justify-between">
                                            ...
                                            <span class="px-2 py-1 rounded-full text-xs font-semibold
                                                                                   <?php if($userTask->isOverdue()): ?> bg-red-100 text-red-800
                                                                                   <?php elseif($userTask->status === 'taken'): ?> bg-yellow-100 text-yellow-800
                                                                                   <?php elseif($userTask->status === 'pending_verification_1'): ?> bg-orange-100 text-orange-800
                                                                                   <?php elseif($userTask->status === 'pending_verification_2'): ?> bg-purple-100 text-purple-800
                                                                                   ...
                                                                                   <?php elseif($userTask->status === 'cancelled'): ?> bg-gray-100 text-gray-800
                                                ...
                                                <div class="text-right">
                                                    <div
                                                        class="px-2 py-1 rounded-full text-xs font-semibold
                                                                                                   <?php if($userTask->payment_status === 'success'): ?> bg-violet-100 text-purple-800
                                                                                                   <?php elseif($userTask->payment_status === 'failed'): ?> bg-red-100 text-red-800
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($userTask->deadline_at): ?>
                                            <div class="flex items-center justify-between">
                                                ...
                                                <span
                                                    class="text-xs <?php echo e($userTask->isOverdue() ? 'text-red-600 font-bold' : 'text-zinc-600'); ?>">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($userTask->status === 'failed' && $userTask->failed_count > 0): ?>
                                            <div class="flex items-center justify-between">
                                                ...
                                                <span class="text-xs text-red-600 font-bold"><?php echo e($userTask->failed_count); ?>x</span>
                                            </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($filter === 'available'): ?>
                                    ...
                                    <?php else: ?>
                                        <button wire:click="takeTask(<?php echo e($task->id); ?>)" wire:loading.attr="disabled"
                                            wire:loading.class="opacity-50 cursor-wait" wire:target="takeTask(<?php echo e($task->id); ?>)"
                                            ...
                                            <svg wire:loading wire:target="takeTask(<?php echo e($task->id); ?>)" style="display: none;"
                                                class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
                                                <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4">
                                                </circle>
                                                <path class="opacity-75" fill="currentColor"
                                            ...
                                            <span wire:loading wire:target="takeTask(<?php echo e($task->id); ?>)"
                                ...
                                <?php elseif($filter === 'my_tasks'): ?>
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('user.task.work', $task->id)); ?>"
            ...
            <!--[if BLOCK]><![endif]--><?php if($viewMode === 'categories'): ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <div wire:click="selectCategory(<?php echo e($category->id); ?>)" wire:loading.class="opacity-50 cursor-wait"
                            wire:target="selectCategory(<?php echo e($category->id); ?>)"
                            class="bg-white rounded-xl border <?php echo e($isPremiumAdmin ? 'border-amber-400 ring-2 ring-amber-200' : 'border-zinc-200'); ?> p-6 hover:shadow-lg transition-all duration-200 cursor-pointer group hover:border-violet-300 relative overflow-hidden">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                ?>
                                <div
                                    class="w-12 h-12 <?php echo e($isPremiumAdmin ? 'bg-gradient-to-br from-amber-400 to-yellow-500' : 'bg-gradient-to-br from-blue-500 to-purple-600'); ?> rounded-lg flex items-center justify-center text-white font-bold text-lg group-hover:scale-110 transition-transform duration-200 shadow-lg">
                                    <?php echo e($initials); ?>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center gap-2 text-sm">
                                        <span class="text-zinc-600"><?php echo e($category->available_tasks_count); ?> task tersedia</span>
                                        <!--[if BLOCK]><![endif]--><?php if($category->in_progress_count > 0): ?>
                                            <span class="text-amber-600">• <?php echo e($category->in_progress_count); ?> dikerjakan</span>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($category->createdBy): ?>
                                <div
                                    class="mt-4 flex items-center gap-2 text-sm <?php echo e($isPremiumAdmin ? 'text-amber-600' : 'text-zinc-500'); ?>">
            ...
            <?php else: ?>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-200 rounded-xl p-5">
                        <h1 class="text-2xl font-bold text-zinc-900 text-center"><?php echo e($selectedCategoryName); ?></h1>
                                    ...
                                    <div class="border-t border-zinc-200 pt-4 space-y-3">
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($userTask->deadline_at): ?>
                                            <div class="flex items-center justify-between">
                                                ...
                                                <span
                                                    class="text-sm <?php echo e($userTask->isOverdue() ? 'text-red-600 font-bold' : 'text-zinc-600'); ?>">
                                                    <?php echo e($userTask->deadline_at->format('d M Y H:i')); ?>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($userTask->status === 'failed' && $userTask->failed_count > 0): ?>
                                            <div class="flex items-center justify-between">
                                                ...
                                                <span class="text-sm text-red-600 font-bold"><?php echo e($userTask->failed_count); ?>x</span>
                                            </div>
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    </div>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-xl p-3 sm:p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-base sm:text-lg font-bold text-amber-800"><?php echo e($lastTaskDate); ?></p>
                                <p class="text-xs text-amber-600 mt-0.5"><?php echo e($daysSinceLastTask); ?></p>
                            </div>
                        </div>
                    </div>
...
</div><?php /**PATH C:\laragon\www\baru\resources\views/livewire/task-dashboard.blade.php ENDPATH**/ ?>